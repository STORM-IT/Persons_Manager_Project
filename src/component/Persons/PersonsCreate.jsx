        ...
        <Fragment>
            <div className="box_person">
                                ...
                                <InputGroup>
                                    ...
                                    <Button variant='primary' onClick={()=>edit_person(id,Name,Age)} className="btn  w-25">Edite</Button>
                                </InputGroup>
                                <br />
                                <InputGroup>
                                    <FormControl onChange={event => Age = event.target.value} className="Clear" placeholder={age} />
                                    <Button variant='primary' onClick={() => edit_person(id,Name, Age)} className="w-25">Edite</Button>
                                </InputGroup>
                                <br />
